...
from events.registry import register_event_handlers
from routers import account, auth, stocks, ai_analysis, ticker, orders
...
api_router.include_router(account.router, prefix="/account", **protected)
